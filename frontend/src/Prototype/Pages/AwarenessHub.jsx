...
export default function AwarenessHub() {
  ...
  const filteredContent = useMemo(() => {
    ...
    return mockContent.filter((item) => {
      ...
      const matchesSearch = !s || title.includes(s) || summary.includes(s);
  ...
  const handleReadMore = (item) => {
    // Replace later with navigate(`/awareness/${item.id}`) when you add a details page
    alert(`Open article: ${item.title}`);
  };
                  ...
                  <div key={item.id} className="featured-card">
                    ...
                    <div className="card-body">
                      ...
                      <div className="card-footer">
                        ...
                        <button
                          type="button"
                          className="read-more-btn-outline"
